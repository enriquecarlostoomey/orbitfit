...
print()
print()
print("first run: 60 seconds step, 12h propagation, a unpert")
print()
...
print()
print()
print("Second case: 60 seconds step, 12h propagation, a perturbed")
print()
...
print()
print()
print("Third case: 60 seconds step, 2 day propagation, a unperturbed")
print()
...
posvel_client_ECI_m = np.array([-2528776.634917358, -637910.2273496351, -6454161.018921344, 5660.809351470285, 4262.999013701585, -2623.9097735226724])
epoch = dateutil.parser.parse("2021-03-09T16:08:14.991000Z")
duration = 2   # days of propagation
oe_client_ECI = np.array(rv2oe(posvel_client_ECI_m[0:3]*1e-3, posvel_client_ECI_m[3:6]*1e-3))
...
print()
print()
print("Fourth case: 60 seconds step, 2 days prop, a perturbed")
print()
